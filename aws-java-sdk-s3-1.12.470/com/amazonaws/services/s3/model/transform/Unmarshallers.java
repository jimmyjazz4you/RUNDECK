...
public class Unmarshallers {
   ...
   public static final class DeleteBucketEncryptionUnmarshaller implements Unmarshaller<DeleteBucketEncryptionResult, InputStream> {
   ...
   public static final class DeleteBucketOwnershipControlsUnmarshaller implements Unmarshaller<DeleteBucketOwnershipControlsResult, InputStream> {
   ...
   public static final class DeletePublicAccessBlockUnmarshaller implements Unmarshaller<DeletePublicAccessBlockResult, InputStream> {
   ...
   public static final class GetBucketOwnershipControlsUnmarshaller implements Unmarshaller<GetBucketOwnershipControlsResult, InputStream> {
   ...
   public static final class RestoreObjectResultUnmarshaller implements Unmarshaller<RestoreObjectResult, InputStream> {
   ...
   public static final class SetBucketEncryptionUnmarshaller implements Unmarshaller<SetBucketEncryptionResult, InputStream> {
   ...
   public static final class SetBucketOwnershipControlsUnmarshaller implements Unmarshaller<SetBucketOwnershipControlsResult, InputStream> {
   ...
   public static final class SetPublicAccessBlockUnmarshaller implements Unmarshaller<SetPublicAccessBlockResult, InputStream> {
